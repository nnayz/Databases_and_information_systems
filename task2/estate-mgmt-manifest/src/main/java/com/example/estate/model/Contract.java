...
public class Contract {
    ...
    public Contract() {}
    public Contract(int id, String contractNo, LocalDate date, String place,
    ...
    public Contract(String contractNo, LocalDate date, String place,
                    int personId, int estateId) {
    ...
    public void setContractNo(String no) { this.contractNo = no; }
